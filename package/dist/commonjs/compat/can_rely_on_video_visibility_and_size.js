...
exports.default = canRelyOnVideoVisibilityAndSize;
var browser_version_1 = require("./browser_version");
...
function canRelyOnVideoVisibilityAndSize() {
    if (env_detector_1.default.browser !== env_detector_1.default.BROWSERS.Firefox) {
        return true;
    }
    var firefoxVersion = (0, browser_version_1.getFirefoxVersion)();
