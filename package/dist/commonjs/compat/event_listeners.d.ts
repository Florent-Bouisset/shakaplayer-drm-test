...
import type { ICompatPictureInPictureWindow, IEventTarget, IMediaElement, IMediaEncryptedEvent } from "./browser_compatibility_types";
 ...
 */
declare function createCompatibleEventListener(eventNames: Array<"needkey" | "encrypted">, prefixes?: string[]): (element: IEventTargetLike, listener: (event: IMediaEncryptedEvent) => void, cancelSignal: CancellationSignal) => void;
 ...
 * @returns {Object}
 */
declare function getPictureOnPictureStateRef(mediaElement: IMediaElement, stopListening: CancellationSignal): IReadOnlySharedReference<IPictureInPictureEvent>;
/**
 * Returns a reference:
 ...
 * @returns {Object}
 */
declare function getElementResolutionRef(mediaElement: IMediaElement, pipStatusRef: IReadOnlySharedReference<IPictureInPictureEvent>, stopListening: CancellationSignal): IReadOnlySharedReference<{
    width: number | undefined;
    height: number | undefined;
    pixelRatio: number;
}>;
 ...
 * @param {HTMLMediaElement} mediaElement
 */
declare const onLoadedMetadata: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {HTMLMediaElement} mediaElement
 */
declare const onTimeUpdate: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {TextTrackList} mediaElement
 */
declare const onTextTrackAdded: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {TextTrackList} textTrackList
 */
declare const onTextTrackRemoved: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaSource} mediaSource
 * @param {Function} listener
 * @param {Object} cancelSignal
 */
declare const onSourceOpen: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaSource} mediaSource
 * @param {Function} listener
 * @param {Object} cancelSignal
 */
declare const onSourceClose: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaSource} mediaSource
 * @param {Function} listener
 * @param {Object} cancelSignal
 */
declare const onSourceEnded: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaSource} mediaSource
 * @param {Function} listener
 * @param {Object} cancelSignal
 */
declare const onSourceBufferUpdate: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {SourceBufferList} sourceBuffers
 * @param {Function} listener
 * @param {Object} cancelSignal
 */
declare const onRemoveSourceBuffers: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaKeySession} mediaKeySession
 */
declare const onKeyMessage: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaKeySession} mediaKeySession
 */
declare const onKeyAdded: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaKeySession} mediaKeySession
 */
declare const onKeyError: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {MediaKeySession} mediaKeySession
 */
declare const onKeyStatusesChange: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {HTMLMediaElement} mediaElement
 */
declare const onSeeking: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {HTMLMediaElement} mediaElement
 */
declare const onSeeked: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 * @param {HTMLMediaElement} mediaElement
 */
declare const onEnded: (element: IEventTargetLike, listener: (event?: Event) => void, cancelSignal: CancellationSignal) => void;
/**
 ...
 * emits
 */
declare function addEventListener(elt: IEventEmitterLike | IEventTarget<Record<string, Event>>, evt: string, listener: (x?: unknown) => void, stopListening: CancellationSignal): void;
