...
function hasIssuesWithHighMediaSourceDuration() {
    var FORCE_HAS_ISSUES_WITH_HIGH_MEDIA_SOURCE_DURATION = config_1.default.getCurrent().FORCE_HAS_ISSUES_WITH_HIGH_MEDIA_SOURCE_DURATION;
    // For now only seen on the Webkit present in the PlayStation 5, for which the
    // alternative is known to work.
    return (FORCE_HAS_ISSUES_WITH_HIGH_MEDIA_SOURCE_DURATION ||
