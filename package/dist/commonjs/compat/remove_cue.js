...
function removeCue(track, cue) {
    ...
    if (env_detector_1.default.browser === env_detector_1.default.BROWSERS.Firefox && isActiveCue(track, cue)) {
        ...
        try {
            ...
            log_1.default.warn("text", "Could not remove cue from text track.");
        }
