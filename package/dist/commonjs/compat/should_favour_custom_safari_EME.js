...
var custom_media_keys_1 = require("./eme/custom_media_keys");
...
function shouldFavourCustomSafariEME() {
    var FORCE_SHOULD_FAVOUR_CUSTOM_SAFARI_EME = config_1.default.getCurrent().FORCE_SHOULD_FAVOUR_CUSTOM_SAFARI_EME;
    ...
    return ((env_detector_1.default.browser === env_detector_1.default.BROWSERS.SafariDesktop ||
        ...
        (0, custom_media_keys_1.getWebKitMediaKeysConstructor)() !== undefined);
}
