...
function shouldUnsetMediaKeys() {
    var FORCE_SHOULD_UNSET_MEDIA_KEYS = config_1.default.getCurrent().FORCE_SHOULD_UNSET_MEDIA_KEYS;
    return (FORCE_SHOULD_UNSET_MEDIA_KEYS || env_detector_1.default.browser === env_detector_1.default.BROWSERS.Ie11);
}
