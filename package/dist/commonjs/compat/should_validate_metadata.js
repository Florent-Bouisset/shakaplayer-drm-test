...
function shouldValidateMetadata() {
    var FORCE_SHOULD_VALIDATE_METADATA = config_1.default.getCurrent().FORCE_SHOULD_VALIDATE_METADATA;
    return FORCE_SHOULD_VALIDATE_METADATA || env_detector_1.default.isSamsungBrowser;
}
