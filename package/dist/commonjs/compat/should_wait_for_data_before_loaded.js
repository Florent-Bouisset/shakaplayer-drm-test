...
exports.default = shouldWaitForDataBeforeLoaded;
...
function shouldWaitForDataBeforeLoaded(isDirectfile) {
    var FORCE_DONT_WAIT_FOR_DATA_BEFORE_LOADED = config_1.default.getCurrent().FORCE_DONT_WAIT_FOR_DATA_BEFORE_LOADED;
