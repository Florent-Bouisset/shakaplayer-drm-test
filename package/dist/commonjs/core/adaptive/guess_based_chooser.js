...
var GuessBasedChooser = /** @class */ (function () {
    ...
    GuessBasedChooser.prototype.getGuess = function (representations, observation, currentRepresentation, incomingBestBitrate, requests) {
        ...
        if (this._isLastGuessValidated(lastChosenRep, incomingBestBitrate, scoreData)) {
            log_1.default.debug("ABR", "Guessed Representation validated", {
                chosenBitrate: lastChosenRep.bitrate,
                otherAbrAlgosBitrate: incomingBestBitrate,
                scoreData: scoreData === null || scoreData === void 0 ? void 0 : scoreData.score,
                scoreConfidence: scoreData === null || scoreData === void 0 ? void 0 : scoreData.confidenceLevel,
            });
