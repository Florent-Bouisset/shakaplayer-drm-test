...
var ManifestFetcher = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, finish(res.manifest)];
                    case 2: return [4 /*yield*/, res];
                    case 3:
                        manifest = (_b.sent()).manifest;
                        return [2 /*return*/, finish(manifest)];
    ...
    ManifestFetcher.prototype._recursivelyRefreshManifest = function (manifest, _a) {
        ...
        if (manifest.lifetime !== undefined && manifest.lifetime >= 0) {
            ...
            if (totalUpdateTime === undefined) {
                ...
                log_1.default.info("MF", "Manifest update rythm is too frequent. Postponing next request.", { regularRefreshDelay: regularRefreshDelay, newRefreshDelay: actualRefreshInterval });
            }
                ...
                // performance seems to have been abysmal one time.
                regularRefreshDelay * 6);
                log_1.default.info("MF", "Manifest took too long to parse. Postponing next request", {
                    regularRefreshDelay: regularRefreshDelay,
    ...
    ManifestFetcher.prototype._triggerNextManifestRefresh = function (manifest, _a) {
        ...
        if (unsafeMode) {
            ...
            log_1.default.info("MF", 'Refreshing the Manifest in "unsafeMode" for the ' +
                String(this._consecutiveUnsafeMode) +
                " consecutive time.");
        }
        else if (this._consecutiveUnsafeMode > 0) {
            log_1.default.info("MF", 'Not parsing the Manifest in "unsafeMode" anymore after ' +
                String(this._consecutiveUnsafeMode) +
                " consecutive times.");
        ...
        this._fetchManifest(refreshURL)
            ...
            if (fullRefresh) {
                ...
                try {
                    ...
                    log_1.default.warn("MF", "Attempt to update Manifest failed: ".concat(message), "Re-downloading the Manifest fully");
