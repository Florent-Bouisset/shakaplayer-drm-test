...
exports.getSegmentFetcherRequestOptions = getSegmentFetcherRequestOptions;
 ...
 * @returns {Function}
 */
function createSegmentFetcher(_a) {
    var bufferType = _a.bufferType, pipeline = _a.pipeline, cdnPrioritizer = _a.cdnPrioritizer, cmcdDataBuilder = _a.cmcdDataBuilder, eventListeners = _a.eventListeners, requestOptions = _a.requestOptions;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, schedule_request_1.scheduleRequestWithCdns)(content.representation.cdnMetadata, cdnPrioritizer, callLoaderWithUrl, (0, object_assign_1.default)({ onRetry: onRetry }, requestOptions), cancellationSignal)];
                    case 2:
                        res = _d.sent();
 ...
 * @returns {Object}
 */
function getSegmentFetcherRequestOptions(_a) {
