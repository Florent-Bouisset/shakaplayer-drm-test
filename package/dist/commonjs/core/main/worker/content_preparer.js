...
var ContentPreparer = /** @class */ (function () {
    ...
    ContentPreparer.prototype.initializeNewContent = function (context) {
        ...
        return new Promise(function (res, rej) {
            ...
            var manifestFetcher = new fetchers_1.ManifestFetcher(url === undefined ? undefined : [url], dashPipelines, __assign({ cmcdDataBuilder: cmcdDataBuilder }, context.manifestRetryOptions));
            ...
            var segmentQueueCreator = new fetchers_1.SegmentQueueCreator(dashPipelines, cdnPrioritizer, cmcdDataBuilder, context.segmentRetryOptions);
            var fetchThumbnailData = (0, thumbnail_fetcher_1.default)(dashPipelines.thumbnails, cdnPrioritizer);
    ...
    ContentPreparer.prototype.reloadMediaSource = function () {
        ...
        }, this._currentMediaSourceCanceller.signal), 3), mediaSourceInterface = _a[0], segmentSinksStore = _a[1], workerTextSender = _a[2];
...
function createMediaSourceInterfaceAndSegmentSinksStore(contentId, capabilities, cancelSignal) {
    ...
    if (capabilities.useMseInWorker) {
        ...
        mediaSourceInterface = new worker_media_source_interface_1.default(generateMediaSourceId(), contentId, send_message_1.default);
    }
