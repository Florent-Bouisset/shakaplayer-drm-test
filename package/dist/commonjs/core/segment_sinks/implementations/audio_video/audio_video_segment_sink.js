...
var AudioVideoSegmentSink = /** @class */ (function (_super) {
    ...
    function AudioVideoSegmentSink(bufferType, codec, mediaSource) {
        ...
        log_1.default.info("Stream", "calling `mediaSource.addSourceBuffer`", { codec: codec });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        log_1.default.debug("Stream", "queuing push order", (0, manifest_1.getLoggableSegmentId)(infos.inventoryInfos));
                        ...
                        promise = Promise.all(dataToPush.map(function (data) {
                            ...
                            log_1.default.debug("Stream", "now pushing", (0, manifest_1.getLoggableSegmentId)(infos.inventoryInfos));
    ...
    AudioVideoSegmentSink.prototype.removeBuffer = function (start, end) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        log_1.default.debug("Stream", "queuing remove order", {
    ...
    AudioVideoSegmentSink.prototype.dispose = function () {
        try {
            log_1.default.debug("Stream", "Calling `dispose` on the SourceBufferInterface");
            this._sourceBuffer.dispose();
        }
        catch (e) {
            log_1.default.debug("Stream", "Failed to dispose a ".concat(this.bufferType, " SourceBufferInterface:"), e instanceof Error ? e : "Unknown Error");
        }
    };
    /**
