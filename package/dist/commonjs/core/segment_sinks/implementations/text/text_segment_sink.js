...
var TextSegmentSink = /** @class */ (function (_super) {
    ...
    function TextSegmentSink(textDisplayerSender) {
        var _this = this;
        log_1.default.debug("Stream", "Creating TextSegmentSink");
    ...
    TextSegmentSink.prototype.declareInitSegment = function (uniqueId) {
        log_1.default.warn("Stream", "Declaring initialization segment for  Text SegmentSink", {
            uniqueId: uniqueId,
        });
    };
    /**
    ...
    TextSegmentSink.prototype.freeInitSegment = function (uniqueId) {
        log_1.default.warn("Stream", "Freeing initialization segment for  Text SegmentSink", {
            uniqueId: uniqueId,
        });
    };
    /**
...
function assertChunkIsTextTrackSegmentData(chunk) {
    ...
    if (typeof chunk !== "object" ||
        chunk === null ||
        (0, is_null_or_undefined_1.default)(chunk.data)) {
