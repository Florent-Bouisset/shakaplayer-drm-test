...
var SegmentSinksStore = /** @class */ (function () {
    ...
    SegmentSinksStore.prototype.disableSegmentSink = function (bufferType) {
        ...
        if (currentValue === null) {
            log_1.default.warn("Stream", "The ".concat(bufferType, " SegmentSink was already disabled."));
            return;
        }
        ...
        if (SegmentSinksStore.isNative(bufferType)) {
            ...
            (0, assert_1.default)(this._onNativeBufferAddedOrDisabled.length === 0);
        }
    };
    /**
    ...
    SegmentSinksStore.prototype.createSegmentSink = function (bufferType, codec) {
        ...
        if (shouldHaveNativeBuffer(bufferType)) {
            if (!(0, is_null_or_undefined_1.default)(memorizedSegmentSink)) {
                if (memorizedSegmentSink instanceof implementations_1.AudioVideoSegmentSink &&
                    ...
                    log_1.default.warn("Stream", "Reusing native SegmentSink with codec", memorizedSegmentSink.codec, "for codec", codec);
                }
                else {
                    log_1.default.info("Stream", "Reusing native SegmentSink with codec", codec);
                }
                return memorizedSegmentSink;
            }
            log_1.default.info("Stream", "Adding native SegmentSink with codec", codec);
        ...
        if (!(0, is_null_or_undefined_1.default)(memorizedSegmentSink)) {
            log_1.default.info("Stream", "Reusing a previous custom SegmentSink", { bufferType: bufferType });
            return memorizedSegmentSink;
        }
        var segmentSink;
        if (bufferType === "text") {
            log_1.default.info("Stream", "Creating a new text SegmentSink");
            if (this._textInterface === null) {
        ...
        log_1.default.error("Stream", "Unknown buffer type:", { bufferType: bufferType });
    ...
    SegmentSinksStore.prototype.disposeSegmentSink = function (bufferType) {
        var memorizedSegmentSink = this._initializedSegmentSinks[bufferType];
        if ((0, is_null_or_undefined_1.default)(memorizedSegmentSink)) {
            log_1.default.warn("Stream", "Trying to dispose a SegmentSink that does not exist", {
                bufferType: bufferType,
            });
            return;
        }
        log_1.default.info("Stream", "Aborting SegmentSink", { bufferType: bufferType });
