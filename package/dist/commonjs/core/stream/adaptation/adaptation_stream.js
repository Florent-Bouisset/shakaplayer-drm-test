...
function AdaptationStream(_a, callbacks, parentCancelSignal) {
    ...
    var initialRepresentations = getRepresentationList(content.adaptation.representations, initialRepIds);
    ...
    var isMediaSegmentQueueInterrupted = new reference_1.default(false);
    /** Update the `canLoad` ref on observation update */
    playbackObserver.listen(function (observation) {
        var _a;
        var observationCanStream = (_a = observation.canStream) !== null && _a !== void 0 ? _a : true;
        if (isMediaSegmentQueueInterrupted.getValue() === observationCanStream) {
            log_1.default.debug("Stream", "isMediaSegmentQueueInterrupted updated to", !observationCanStream);
    ...
    estimateRef.onUpdate(function (_a) {
        ...
        log_1.default.debug("Stream", "new ".concat(adaptation.type, " bitrate estimate received from ABR"), {
            bitrate: bitrate,
        });
    ...
    function recursivelyCreateRepresentationStreams(fnCancelSignal) {
        ...
        estimateRef.onUpdate(function (estimate) {
            ...
            if (estimate.urgent) {
                log_1.default.info("Stream", "urgent Representation switch", {
                    bufferType: adaptation.type,
                ...
                log_1.default.info("Stream", "slow Representation switch", {
                    bufferType: adaptation.type,
                    estimateBitrate: estimate.bitrate,
                    prevRepresentationBitrate: representation.bitrate,
                    newRepresentationBitrate: estimate.representation.bitrate,
    ...
    function createRepresentationStream(representation, terminateCurrentStream, representationStreamCallbacks, fnCancelSignal) {
        ...
        log_1.default.info("Stream", "changing representation", {
            bufferType: adaptation.type,
        ...
        var updatedCallbacks = (0, object_assign_1.default)({}, representationStreamCallbacks, {
            error: function (err) {
                ...
                if (formattedError.code !== "BUFFER_FULL_ERROR") {
                    ...
                    log_1.default.warn("Stream", "received BUFFER_FULL_ERROR", {
                        bufferType: adaptation.type,
                        representationBitrate: representation.bitrate,
                    });
                    ...
                    (0, cancellable_sleep_1.default)(4000, fnCancelSignal)
                        .then(function () {
...
function getRepresentationList(availableRepresentations, authorizedRepIds) {
    var filteredRepresentations = availableRepresentations.filter(function (r) {
        return (0, array_includes_1.default)(authorizedRepIds, r.id) &&
            !r.shouldBeAvoided &&
            r.isPlayable() !== false;
    });
    ...
    return availableRepresentations.filter(function (r) { return (0, array_includes_1.default)(authorizedRepIds, r.id) && r.isPlayable() !== false; });
}
