...
function StreamOrchestrator(content, playbackObserver, representationEstimator, segmentSinksStore, segmentQueueCreator, options, callbacks, orchestratorCancelSignal) {
    ...
    function manageEveryStreams(bufferType, basePeriod) {
        ...
        playbackObserver.listen(function (_a) {
            ...
            var getNewBasePeriod = function () { var _a; return (_a = manifest.getPeriodForTime(time)) !== null && _a !== void 0 ? _a : manifest.getNextPeriod(time); };
            var nextPeriod = getNewBasePeriod();
            if (!(0, is_null_or_undefined_1.default)(nextPeriod) && periodList.has(nextPeriod)) {
                // Last check just for resilience reasons that the wanted Period is
                // not one of the already-handled ones
                return;
            }
            log_1.default.info("Stream", "Destroying all PeriodStreams due to out of bounds situation", { bufferType: bufferType, time: time });
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            enableOutOfBoundsCheck = false;
                            log_1.default.info("Stream", "Destroying all PeriodStreams for decipherability matters", {
    ...
    function manageConsecutivePeriodStreams(bufferType, basePeriod, consecutivePeriodStreamCb, cancelSignal) {
        log_1.default.info("Stream", "Creating new PeriodStream", {
            bufferType: bufferType,
        ...
        playbackObserver.listen(function (_a, stopListeningObservations) {
            ...
            if (basePeriod.end !== undefined && position.getWanted() >= basePeriod.end) {
                ...
                log_1.default.info("Stream", "Destroying PeriodStream as the current playhead moved above it", {
                    bufferType: bufferType,
                    periodStart: basePeriod.start,
        ...
        var periodStreamCallbacks = __assign(__assign({}, consecutivePeriodStreamCb), { streamStatusUpdate: function (value) {
                if (value.hasFinishedLoading) {
                    ...
                    log_1.default.info("Stream", "Destroying next PeriodStream due to current one being active", {
                        bufferType: bufferType,
                        periodStart: basePeriod.start,
        ...
        function checkOrCreateNextPeriodStream(nextPeriod) {
            if (nextStreamInfo !== null) {
                ...
                log_1.default.warn("Stream", "Creating next `PeriodStream` while one was already created.", {
                    bufferType: bufferType,
                ...
                if (updates.addedPeriods.length > 0) {
                    ...
                    if (nextStreamInfo !== null) {
                        ...
                        if (newNextPeriod === null ||
                            ...
                            log_1.default.warn("Stream", "Destroying next PeriodStream due to new one being added", {
                                bufferType: bufferType,
                                nextPeriodStart: nextStreamInfo.period.start,
                            });
                            consecutivePeriodStreamCb.periodStreamCleared({
