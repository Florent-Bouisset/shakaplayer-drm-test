            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        currentStreamCanceller === null || currentStreamCanceller === void 0 ? void 0 : currentStreamCanceller.cancel(); // Cancel previously created stream if one
                        currentStreamCanceller = streamCanceller;
                        if (!(choice === null)) return [3 /*break*/, 7];
                        // Current type is disabled for that Period
                        log_1.default.info("Stream", "Set no Adaptation", {
                            periodStart: period.start,
                            bufferType: bufferType,
                        });
                        segmentSinkStatus = segmentSinksStore.getStatus(bufferType);
                        if (!(segmentSinkStatus.type === "initialized")) return [3 /*break*/, 5];
                        log_1.default.info("Stream", "Clearing previous SegmentSink", {
                            periodStart: period.start,
                            bufferType: bufferType,
                        });
                    ...
                    case 7:
                        ...
                        if (adaptation === undefined) {
                            ...
                            log_1.default.warn("Stream", "Unfound chosen Adaptation choice", {
                        ...
                        log_1.default.info("Stream", "Updating adaptation", {
...
function createOrReuseSegmentSink(segmentSinksStore, bufferType, adaptation) {
    ...
    if (segmentSinkStatus.type === "initialized") {
        log_1.default.info("Stream", "Reusing a previous SegmentSink for the type", { bufferType: bufferType });
...
function getFirstDeclaredMimeType(adaptation) {
    var representations = adaptation.representations.filter(function (r) { return r.isPlayable() !== false; });
...
function createEmptyAdaptationStream(playbackObserver, wantedBufferAhead, bufferType, content, callbacks, cancelSignal) {
    ...
    function sendStatus() {
        ...
        if (period.end !== undefined && position + wba >= period.end) {
            log_1.default.debug("Stream", 'full "empty" AdaptationStream', {
                bufferType: bufferType,
