...
import type { IAdaptationChoice, IAdaptationStreamCallbacks, IAdaptationStreamOptions } from "../adaptation";
...
export interface IPeriodStreamArguments {
    ...
    garbageCollectors: WeakMapMemory<SegmentSink, (cancelSignal: CancellationSignal) => void>;
