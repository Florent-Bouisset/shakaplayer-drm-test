...
function checkForDiscontinuity(content, checkedRange, nextSegmentStart, hasFinishedLoading, bufferedSegments) {
    ...
    nextBufferedSegment.bufferedStart !== undefined &&
        ...
        log_1.default.debug("Stream", "current discontinuity encountered", {
    ...
    if (nextHoleIdx !== null) {
        ...
        if (nextSegmentStart === null ||
            ...
            log_1.default.debug("Stream", "future discontinuity encountered", {
                bufferType: adaptation.type,
        ...
        if (hasFinishedLoading && period.end !== undefined) {
            ...
            if (lastBufferedInPeriodIdx !== null) {
                ...
                if (lastSegment.bufferedEnd !== undefined &&
                    ...
                    log_1.default.debug("Stream", "discontinuity encountered at the end of the current period", {
                        bufferType: adaptation.type,
...
function getIndexOfFirstDiscontinuityBetweenChunks(bufferedChunks, range, startFromIndex) {
    if (startFromIndex <= 0) {
        log_1.default.error("Stream", "Asked to check a discontinuity before the first chunk.");
        return null;
    }
