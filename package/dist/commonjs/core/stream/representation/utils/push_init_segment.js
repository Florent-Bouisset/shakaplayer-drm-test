 ...
 * @returns {Promise}
 */
function pushInitSegment(_a, cancelSignal_1) {
    return __awaiter(this, arguments, void 0, function (_b, cancelSignal) {
        var codec, data, inventoryInfos, buffered;
        var playbackObserver = _b.playbackObserver, content = _b.content, initSegmentUniqueId = _b.initSegmentUniqueId, segment = _b.segment, segmentSink = _b.segmentSink, bufferGoal = _b.bufferGoal;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    inventoryInfos = (0, object_assign_1.default)({ segment: segment, chunkSize: undefined, start: 0, end: 0 }, content);
