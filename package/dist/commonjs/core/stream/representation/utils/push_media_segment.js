 ...
 * @returns {Promise}
 */
function pushMediaSegment(_a, cancelSignal_1) {
    return __awaiter(this, arguments, void 0, function (_b, cancelSignal) {
        ...
        var _c, _d;
        var playbackObserver = _b.playbackObserver, bufferGoal = _b.bufferGoal, content = _b.content, initSegmentUniqueId = _b.initSegmentUniqueId, parsedSegment = _b.parsedSegment, segment = _b.segment, segmentSink = _b.segmentSink;
