 ...
 * @returns {Promise}
 */
export default function loadAndPushSegment(segmentInfo: ISegmentLoaderContent, sourceBufferInterface: MainSourceBufferInterface, segmentFetcher: ISegmentFetcher<ArrayBuffer | Uint8Array<ArrayBuffer>>, cancelSignal: CancellationSignal): Promise<unknown>;
