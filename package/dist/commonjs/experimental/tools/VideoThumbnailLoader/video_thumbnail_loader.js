...
var VideoThumbnailLoader = /** @class */ (function () {
    ...
    VideoThumbnailLoader.prototype.setTime = function (time) {
        ...
        if (neededSegments.length === 0) {
            ...
            log_1.default.debug("VideoThumbnailLoader", "Thumbnails already loaded.", time);
            return Promise.resolve(time);
        }
        if (log_1.default.hasLevel("DEBUG")) {
            log_1.default.debug("VideoThumbnailLoader", "Found thumbnail for time", time, neededSegments.map(function (s) { return "start: ".concat(s.time, " - end: ").concat(s.end); }).join(", "));
        }
        ...
        return lastRepInfo.sourceBuffer
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        abortUnlistedSegmentRequests(lastRepInfo.pendingRequests, neededSegments);
                        log_1.default.debug("VideoThumbnailLoader", "Removing buffer around time.", time);
