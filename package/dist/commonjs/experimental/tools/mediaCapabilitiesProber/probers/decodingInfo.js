...
function probeDecodingInfos(config) {
    return __awaiter(this, void 0, void 0, function () {
        var hasVideoConfig, hasAudioConfig, result, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hasVideoConfig = config.type !== undefined &&
                    ...
                    hasAudioConfig = config.type !== undefined &&
                        config.type.length > 0 &&
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, navigator.mediaCapabilities.decodingInfo(config)];
                case 2:
                    result = _a.sent();
                    return [2 /*return*/, result.supported ? "Supported" : "NotSupported"];
                case 3:
                    err_1 = _a.sent();
