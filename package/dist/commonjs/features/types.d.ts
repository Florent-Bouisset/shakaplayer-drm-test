 ...
 */
export type IHTMLTextTracksBuffer = new (mediaElement: IMediaElement, textTrackElement: HTMLElement) => SegmentSink;
/**
 * Function allowing to implement a text track rendered by displaying them
...
export type IDashJsParser = (xml: string, args: IMPDParserArguments) => IDashParserResponse<string>;
/**
 ...
 */
export type IDebugElementFn = (parentElt: HTMLElement, instance: IRxPlayer, cancelSignal: CancellationSignal) => void;
/**
...
export interface IFeaturesObject {
     ...
     */
    htmlTextTracksParsers: Partial<Record<ISupportedTextTrackFormat, IHTMLTextTracksParserFn>>;
    /**
     ...
     * elements.
     */
    nativeTextTracksParsers: Partial<Record<ISupportedTextTrackFormat, INativeTextTracksParserFn>>;
}
/**
