 ...
 */
function initMediaKeys(eme, mediaElement, keySystemsConfigs, cancelSignal) {
    return __awaiter(this, void 0, void 0, function () {
        var mediaKeysInfo, mediaKeys, shouldDisableOldMediaKeys;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, get_media_keys_1.default)(eme, mediaElement, keySystemsConfigs, cancelSignal)];
                case 1:
                ...
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [2 /*return*/, mediaKeysInfo];
            }
        });
    });
}
