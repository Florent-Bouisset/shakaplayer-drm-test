...
function SessionEventsListener(session, keySystemOptions, mediaKeySystemAccess, callbacks, cancelSignal) {
    var _this = this;
    log_1.default.info("DRM", "Binding session events", { sessionId: session.sessionId });
    ...
    (0, event_listeners_1.onKeyStatusesChange)(session, function () {
        log_1.default.info("DRM", "keystatuseschange event received", {
    ...
    (0, event_listeners_1.onKeyMessage)(session, function (evt) {
        ...
        var messageType = (0, is_non_empty_string_1.default)(messageEvent.messageType)
            ...
            : "license-request";
        log_1.default.info("DRM", "Received message event", {
            messageType: messageType,
            sessionId: session.sessionId,
        });
        var backoffOptions = getLicenseBackoffOptions(getLicenseConfig.retry);
        (0, retry_promise_with_backoff_1.default)(function () { return runGetLicense(message, messageType); }, backoffOptions, manualCanceller.signal).then(function (licenseObject) { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(0, is_null_or_undefined_1.default)(licenseObject)) return [3 /*break*/, 1];
    ...
    log_1.default.info("DRM", "transmitting current keystatuses", { sessionId: session.sessionId });
    checkAndHandleCurrentKeyStatuses();
    return;
    /**
    ...
    function runGetLicense(message, messageType) {
        ...
        return new Promise(function (res, rej) {
            try {
                log_1.default.debug("DRM", "Calling `getLicense`", { messageType: messageType });
