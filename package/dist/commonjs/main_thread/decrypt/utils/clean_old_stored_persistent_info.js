...
exports.default = cleanOldStoredPersistentInfo;
...
function cleanOldStoredPersistentInfo(persistentSessionsStore, limit) {
    ...
    log_1.default.info("DRM", "Too many stored persistent sessions, removing some.", {
        numberOfPersistentSessions: numberOfPersistentSessions,
        toDelete: toDelete,
    });
