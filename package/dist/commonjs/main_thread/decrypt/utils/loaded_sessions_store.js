...
var LoadedSessionsStore = /** @class */ (function () {
    ...
    LoadedSessionsStore.prototype.createSession = function (initData, sessionType) {
        ...
        log_1.default.debug("DRM", "calling `createSession`", { sessionType: sessionType });
        ...
        if (!(0, is_null_or_undefined_1.default)(mediaKeySession.closed)) {
            mediaKeySession.closed
                .then(function () {
                log_1.default.info("DRM", "session was closed, removing it.", {
                ...
                log_1.default.warn("DRM", "MediaKeySession.closed rejected: ".concat(e));
            });
        }
        this._storage.push(__assign({}, entry));
        log_1.default.debug("DRM", "MediaKeySession added", {
    ...
    LoadedSessionsStore.prototype.reuse = function (initializationData) {
        for (var i = this._storage.length - 1; i >= 0; i--) {
            ...
            if (stored.keySessionRecord.isCompatibleWith(initializationData)) {
                ...
                log_1.default.debug("DRM", "Reusing session:", {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (entry === undefined) {
                            log_1.default.error("DRM", "generateRequest error. No MediaKeySession found with " +
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (entry === undefined) {
                            log_1.default.error("DRM", "loadPersistentSession error. No MediaKeySession found with " +
                                "the given initData and initDataType");
    ...
    LoadedSessionsStore.prototype.closeSession = function (mediaKeySession) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                if (entry === undefined) {
                    log_1.default.warn("DRM", "No MediaKeySession found with " + "the given initData and initDataType");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        log_1.default.debug("DRM", "Closing all current MediaKeySessions", {
    ...
    LoadedSessionsStore.prototype.removeSessionWithoutClosingIt = function (mediaKeySession) {
        ...
        for (var i = this._storage.length - 1; i >= 0; i--) {
            var stored = this._storage[i];
            if (stored.mediaKeySession === mediaKeySession) {
                log_1.default.debug("DRM", "Removing session without closing it", {
                    sessionId: mediaKeySession.sessionId,
                });
                this._storage.splice(i, 1);
                return true;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sessionId = mediaKeySession.sessionId;
                    log_1.default.debug("DRM", "Trying to close a MediaKeySession", {
                        sessionId: sessionId,
                    });
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    log_1.default.error("DRM", "Could not close MediaKeySession: " +
                        (err_3 instanceof Error ? err_3.toString() : "Unknown error"), { sessionId: sessionId });
                    return [2 /*return*/];
