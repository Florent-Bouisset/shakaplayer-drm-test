 ...
 */
export declare function setAutoplay(mediaElement: IMediaElement, autoplay: boolean, cancellationSignal: CancellationSignal): void;
...
//# sourceMappingURL=directfile_content_initializer.d.ts.map