...
var DirectFileContentInitializer = /** @class */ (function (_super) {
    ...
    DirectFileContentInitializer.prototype.start = function (mediaElement, playbackObserver) {
        ...
        var drmInitRef = (0, initialize_content_decryption_1.default)(mediaElement, keySystems, {
        ...
        drmInitRef.onUpdate(function (evt, stopListeningToDrmUpdates) {
            ...
            log_1.default.info("Init", "Setting URL to HTMLMediaElement", { url: url });
            mediaElement.src = url;
            cancelSignal.register(function () {
                log_1.default.info("Init", "Removing directfile src from media element", {
    ...
    DirectFileContentInitializer.prototype._seekAndPlay = function (mediaElement, playbackObserver) {
        ...
        var initialTime = function () {
            ...
            log_1.default.debug("Init", "Initial time calculated", { initialTime: initTime });
            return initTime;
        };
        (0, initial_seek_and_play_1.default)({
            ...
            return (0, get_loaded_reference_1.default)(playbackObserver, true, cancelSignal).onUpdate(function (isLoaded, stopListening) {
                if (isLoaded) {
                    stopListening();
                    _this.trigger("loaded", {
                        getSegmentSinkMetrics: null,
                        getThumbnailData: function () {
                            return Promise.reject(new Error("Thumbnail data not available with directfile contents"));
                        },
                    });
                }
            }, { emitCurrentValue: true, clearSignal: cancelSignal });
...
function getDirectFileInitialTime(mediaElement, startAt) {
    ...
    if (typeof startAt.fromLastPosition === "number") {
        ...
        log_1.default.warn("Init", "startAt.fromLastPosition set but duration is not known, " +
        ...
        if ((0, is_null_or_undefined_1.default)(livePosition)) {
            log_1.default.warn("Init", "startAt.fromLivePosition set but live position is not known, " +
                "beginning at 0.");
            return 0;
        }
        ...
        if ((0, is_null_or_undefined_1.default)(duration) || !isFinite(duration)) {
            log_1.default.warn("Init", "startAt.percentage set but duration is not known, " + "beginning at 0.");
            return 0;
        }
