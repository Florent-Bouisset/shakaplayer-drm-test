...
import type { IPublicNonFiniteStreamEvent, IPublicStreamEvent } from "./utils/stream_events_emitter";
/**
...
export declare abstract class ContentInitializer extends EventEmitter<IContentInitializerEvents> {
     ...
     * intervals.
     */
    abstract start(mediaElement: IMediaElement, playbackObserver: IMediaElementPlaybackObserver): void;
    /**
...
export interface IContentInitializerEvents {
    ...
    loaded: {
         ...
         * @param {number} time
         */
        getThumbnailData: (periodId: string, thumbnailTrackId: string, time: number) => Promise<IThumbnailResponse>;
    };
...
export type IStallingSituation = "seeking" | "not-ready" | "internal-seek" | "buffering" | "freezing";
