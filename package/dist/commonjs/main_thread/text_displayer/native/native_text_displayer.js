...
var NativeTextDisplayer = /** @class */ (function () {
    ...
    function NativeTextDisplayer(videoElement) {
        log_1.default.debug("text", "Creating NativeTextDisplayer");
    ...
    NativeTextDisplayer.prototype.pushTextData = function (infos) {
        var e_1, _a;
        var _b, _c;
        log_1.default.debug("text", "Appending new native text tracks");
        if (infos.chunk === null) {
        ...
        var startTime = chunk.start, endTime = chunk.end, dataString = chunk.data, type = chunk.type, language = chunk.language, initTimescale = chunk.initTimescale;
        ...
        var cues = (0, native_parsers_1.default)(type, dataString, { initTimescale: initTimescale, language: language }, timestampOffset);
    ...
    NativeTextDisplayer.prototype.reset = function () {
        log_1.default.debug("text", "Aborting NativeTextDisplayer");
    ...
    NativeTextDisplayer.prototype.stop = function () {
        ...
        if (_trackElement !== undefined && _videoElement.hasChildNodes()) {
            try {
                ...
                log_1.default.warn("text", "Can't remove track element from the video");
            }
        }
    ...
    NativeTextDisplayer.prototype._removeData = function (start, end) {
        log_1.default.debug("text", "Removing native text track data", { start: start, end: end });
