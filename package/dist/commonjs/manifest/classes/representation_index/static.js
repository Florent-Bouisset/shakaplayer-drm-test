...
var StaticRepresentationIndex = /** @class */ (function () {
    ...
    StaticRepresentationIndex.prototype.initialize = function () {
        log_1.default.error("manifest", "A `StaticRepresentationIndex` does not need to be initialized");
    };
    /**
     ...
     * @returns {number}
     */
    StaticRepresentationIndex.prototype.getTargetSegmentDuration = function () {
        return {
            duration: Number.MAX_VALUE,
            isPrecize: false,
        };
    ...
    StaticRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("manifest", "Cannot add predicted segments to a `StaticRepresentationIndex`");
    };
    StaticRepresentationIndex.prototype._replace = function () {
        log_1.default.warn("manifest", "Tried to replace a static RepresentationIndex");
    };
    StaticRepresentationIndex.prototype._update = function () {
        log_1.default.warn("manifest", "Tried to update a static RepresentationIndex");
    };
