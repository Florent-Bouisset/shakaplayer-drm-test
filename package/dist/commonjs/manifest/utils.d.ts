...
import type { IAudioRepresentation, IAudioTrack, IRepresentationFilter, ITextTrack, ITrackType, IVideoRepresentation, IVideoTrack } from "../public_types";
 ...
 * @returns {Object}
 */
export declare function toAudioRepresentation(representation: IRepresentationMetadata): IAudioRepresentation;
/**
 * Format Representation as an `IVideoRepresentation`.
 * @returns {Object}
 */
export declare function toVideoRepresentation(representation: IRepresentationMetadata): IVideoRepresentation;
