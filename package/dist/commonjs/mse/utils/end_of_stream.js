...
function triggerEndOfStream(mediaSource, cancelSignal) {
    var e_1, _a;
    log_1.default.debug("mse", "Trying to call endOfStream");
    if (mediaSource.readyState !== "open") {
        log_1.default.debug("mse", "MediaSource not open, cancel endOfStream");
        return;
    }
    ...
    if (updatingSourceBuffers.length === 0) {
        log_1.default.info("mse", "Triggering end of stream");
        try {
            mediaSource.endOfStream();
        }
        catch (err) {
            log_1.default.error("mse", "Unable to call endOfStream", err instanceof Error ? err : new Error("Unknown error"));
        }
        return;
    }
    log_1.default.debug("mse", "Waiting SourceBuffers to be updated before calling endOfStream.");
...
function maintainEndOfStream(mediaSource, cancelSignal) {
    ...
    (0, event_listeners_1.onSourceOpen)(mediaSource, function () {
        log_1.default.debug("mse", "MediaSource re-opened while end-of-stream is active");
