...
import type { ISourceBufferInterfaceAppendBufferParameters, SourceBufferType } from "./mse";
...
export type ISentLogValue = ISentLogValueBase | ISentError | Partial<Record<string, ISentLogValueBase>>;
