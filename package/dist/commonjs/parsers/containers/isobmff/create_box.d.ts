 ...
 */
declare function createBox(name: string, buff: Uint8Array): Uint8Array<ArrayBuffer>;
/**
 * @param {string} name
 * @param {Array.<Uint8Array>} children
 * @returns {Uint8Array}
 */
declare function createBoxWithChildren(name: string, children: Uint8Array[]): Uint8Array<ArrayBuffer>;
export { createBox, createBoxWithChildren };
//# sourceMappingURL=create_box.d.ts.map