...
exports.extractInitSegment = extractInitSegment;
 ...
 * @returns {Array}
 */
function extractInitSegment(buffer) {
    var moovIndex = (0, find_complete_box_1.default)(buffer, 0x6d6f6f76 /* moov */);
    if (moovIndex < 0) {
        // no moov, not an init segment.
        return [null, buffer];
    }
    var moovLen = (0, byte_parsing_1.be4toi)(buffer, moovIndex);
    var moovEnd = moovIndex + moovLen;
