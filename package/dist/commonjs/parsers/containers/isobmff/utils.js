...
exports.getTrunSamples = getTrunSamples;
 ...
 */
function getTrunSamples(buffer) {
    var e_1, _a;
    ...
    try {
        for (var trafs_1 = __values(trafs), trafs_1_1 = trafs_1.next(); !trafs_1_1.done; trafs_1_1 = trafs_1.next()) {
            ...
            while (i-- > 0) {
                ...
                if (hasSampleSize) {
                    size = (0, byte_parsing_1.be4toi)(trun, cursor);
                    cursor += 4;
                }
                if (hasSampleFlags) {
                    sampleFlags = (0, byte_parsing_1.be4toi)(trun, cursor);
                    cursor += 4;
                }
                if (hasSampleCompositionOffset) {
                    compositionTimeOffset =
                        version === 0 ? (0, byte_parsing_1.be4toi)(trun, cursor) : (0, byte_parsing_1.be4toiSigned)(trun, cursor);
                    cursor += 4;
                }
                samples.push({
                    duration: duration,
...
function getDurationFromTrun(buffer) {
    ...
    try {
        for (var trafs_2 = __values(trafs), trafs_2_1 = trafs_2.next(); !trafs_2_1.done; trafs_2_1 = trafs_2.next()) {
            var traf = trafs_2_1.value;
            var trun = (0, get_box_1.getBoxContent)(traf, 0x7472756e /* trun */);
            if (trun === null) {
                return undefined;
            }
        ...
        try {
            if (trafs_2_1 && !trafs_2_1.done && (_a = trafs_2.return)) _a.call(trafs_2);
        }
