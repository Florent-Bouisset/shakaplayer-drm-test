...
var BaseRepresentationIndex = /** @class */ (function () {
    ...
    BaseRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("dash", "Cannot add predicted segments to a `BaseRepresentationIndex`");
    };
    /**
     ...
     * @returns {number}
     */
    BaseRepresentationIndex.prototype.getTargetSegmentDuration = function () {
    ...
    BaseRepresentationIndex.prototype._update = function () {
        log_1.default.error("dash", "Base RepresentationIndex: Cannot update a SegmentList");
    };
