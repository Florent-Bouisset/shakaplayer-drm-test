...
var ListRepresentationIndex = /** @class */ (function () {
    ...
    ListRepresentationIndex.prototype.initialize = function () {
        log_1.default.error("dash", "A `ListRepresentationIndex` does not need to be initialized");
    };
    ListRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("dash", "Cannot add predicted segments to a `ListRepresentationIndex`");
    };
    /**
     ...
     * @returns {number}
     */
    ListRepresentationIndex.prototype.getTargetSegmentDuration = function () {
    ...
    ListRepresentationIndex.prototype._update = function () {
        log_1.default.error("dash", "A `ListRepresentationIndex` cannot be updated");
    };
