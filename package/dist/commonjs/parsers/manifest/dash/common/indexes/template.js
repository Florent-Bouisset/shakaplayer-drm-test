...
var TemplateRepresentationIndex = /** @class */ (function () {
    ...
    TemplateRepresentationIndex.prototype.initialize = function () {
        log_1.default.error("dash", "A `TemplateRepresentationIndex` does not need to be initialized");
    };
    TemplateRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("dash", "Cannot add predicted segments to a `TemplateRepresentationIndex`");
    };
    /**
     ...
     * @returns {number}
     */
    TemplateRepresentationIndex.prototype.getTargetSegmentDuration = function () {
        return {
