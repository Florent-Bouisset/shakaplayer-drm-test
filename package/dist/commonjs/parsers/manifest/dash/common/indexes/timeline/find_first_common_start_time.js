...
function findFirstCommonStartTime(prevTimeline, newElements) {
    ...
    var newFirstTAttr = newElements[0].attributes.t;
    ...
    if (prevInitialStart === newInitialStart) {
        ...
        while (true) {
            ...
            var tAttr = newNodeElt.attributes.t;
