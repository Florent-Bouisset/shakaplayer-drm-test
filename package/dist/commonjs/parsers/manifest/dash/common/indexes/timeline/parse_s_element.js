        ...
        for (var _b = __values(Object.keys(root.attributes)), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            switch (attributeName) {
                case "t": {
                    ...
                    if (isNaN(start)) {
                        log_1.default.warn("dash", "invalid t value for <S> element", { val: attributeVal });
                    }
                    else {
                        parsedS.start = start;
                    }
                ...
                case "d": {
                    ...
                    if (isNaN(duration)) {
                        log_1.default.warn("dash", "invalid d value for <S> element", { val: attributeVal });
                    }
                    else {
                ...
                case "r": {
                    ...
                    if (isNaN(repeatCount)) {
                        log_1.default.warn("dash", "invalid r value for <S> element", { val: attributeVal });
                    }
                    else {
