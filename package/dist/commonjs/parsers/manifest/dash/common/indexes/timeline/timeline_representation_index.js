...
var TimelineRepresentationIndex = /** @class */ (function () {
    ...
    TimelineRepresentationIndex.prototype.initialize = function () {
        log_1.default.error("dash", "A `TimelineRepresentationIndex` does not need to be initialized");
    };
    TimelineRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("dash", "Cannot add predicted segments to a `TimelineRepresentationIndex`");
    };
    /**
     ...
     * @returns {number}
     */
    TimelineRepresentationIndex.prototype.getTargetSegmentDuration = function () {
        this._refreshTimeline();
