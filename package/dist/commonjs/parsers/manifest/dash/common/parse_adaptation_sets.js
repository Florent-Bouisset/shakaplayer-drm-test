            ...
            for (var supplementalProperties_1 = __values(supplementalProperties), supplementalProperties_1_1 = supplementalProperties_1.next(); !supplementalProperties_1_1.done; supplementalProperties_1_1 = supplementalProperties_1.next()) {
                ...
                if (supplementalProperty.schemeIdUri ===
                    ...
                    return supplementalProperty.value
                        ...
                        .filter(function (id) { return (0, is_non_empty_string_1.default)(id); });
                }
            }
        }
...
function parseAdaptationSets(adaptationsIR, context) {
    ...
    for (var adaptationIdx = 0; adaptationIdx < adaptationsIR.length; adaptationIdx++) {
        ...
        var type = (0, infer_adaptation_type_1.default)(adaptation, representationsIR);
        if (type === undefined) {
            continue;
        }
        ...
        if (type === "thumbnails") {
            var track = createThumbnailTracks(adaptation, representations);
            if (track !== null) {
                parsedThumbnailTracks.push.apply(parsedThumbnailTracks, __spreadArray([], __read(track), false));
            }
            continue;
        }
            ...
            var _loop_1 = function (id) {
                ...
                if (switchingInfos !== undefined &&
                    ...
                    if (mergedInto !== undefined &&
                        ...
                        log_1.default.info("dash", 'merging "switchable" AdaptationSets', { originalID: originalID, id: id });
    ...
    for (var i = 0; i < representations.length; i++) {
        ...
        if (representation !== undefined) {
            if (representation.mimeType === undefined) {
                log_1.default.warn("dash", "Invalid thumbnails Representation, no mime-type");
                continue;
            }
            var tileInfo = (0, infer_adaptation_type_1.getThumbnailAdaptationSetInfo)(adaptation, adaptation.children.representations[i]);
            if (tileInfo === null) {
                continue;
            }
            if (representation.height === undefined) {
                log_1.default.warn("dash", "Invalid thumbnails Representation, no height information");
                continue;
            }
            if (representation.width === undefined) {
                log_1.default.warn("dash", "Invalid thumbnails Representation, no width information");
                continue;
            }
            var start = (_a = representation.index.getFirstAvailablePosition()) !== null && _a !== void 0 ? _a : undefined;
            var end = (_b = representation.index.getEnd()) !== null && _b !== void 0 ? _b : undefined;
            var segmentDuration = void 0;
            var targetDuration = representation.index.getTargetSegmentDuration();
            if (targetDuration !== undefined && targetDuration.isPrecize) {
                segmentDuration = targetDuration.duration;
            }
            else {
                log_1.default.warn("dash", "Cannot produce duration estimate for thumbnail track");
            }
            tracks.push({
