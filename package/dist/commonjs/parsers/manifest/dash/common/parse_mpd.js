                    ...
                    value: {
                        ...
                        continue: function continueParsingMPD(responseDataClock) {
                            if (!responseDataClock.success) {
                                ...
                                log_1.default.warn("dash", "Error on fetching the clock ressource", responseDataClock.error);
    ...
    if (!isDynamic) {
        ...
        if (maximumSafePosition !== undefined) {
            ...
            if (externalClockOffset === undefined) {
                log_1.default.warn("dash", "use system clock to define maximum position");
