...
export default class DashWasmParser {
     ...
     * @returns {Object}
     */
    runWasmParser(mpd: ArrayBufferLike, args: IMPDParserArguments): IDashParserResponse<string> | IDashParserResponse<ArrayBuffer>;
    /**
...
//# sourceMappingURL=dash-wasm-parser.d.ts.map