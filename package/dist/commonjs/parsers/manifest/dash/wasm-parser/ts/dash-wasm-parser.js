        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            function onCustomEvent(evt, ptr, len) {
                ...
                if (evt === 1 /* CustomEventType.Error */) {
                    ...
                    log_1.default.warn("dash", "WASM Error Event:", decoded);
                    self._warnings.push(new Error(decoded));
                }
                else if (evt === 0 /* CustomEventType.Log */) {
                    var decoded = textDecoder.decode(arr);
                    log_1.default.warn("dash", "WASM Log Event:", decoded);
                }
            }
            /**
            ...
            return __generator(this, function (_a) {
                ...
                this._initProm = streamingProm
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                log_1.default.warn("dash", "Unable to call `instantiateStreaming` on WASM", e instanceof Error ? e : "");
                    ...
                    log_1.default.warn("dash", "Could not create DASH-WASM parser:", message);
