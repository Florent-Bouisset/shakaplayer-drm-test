    ...
    return function onRootChildren(nodeId) {
        switch (nodeId) {
            ...
            case 21 /* TagName.Label */: {
                parsersStack.pushParsers(nodeId, noop_1.default, // Label as treated like an attribute
                (0, Label_1.generateLabelElementParser)(adaptationSetChildren, linearMemory));
                break;
            }
            default:
