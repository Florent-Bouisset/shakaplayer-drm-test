    ...
    return function onContentProtectionAttribute(attr, ptr, len) {
        switch (attr) {
            ...
            case 15 /* AttributeName.ContentProtectionCencPSSH */:
                ...
                break;
            case 78 /* AttributeName.ContentProtectionRef */:
                cpAttrs.ref = (0, utils_1.parseString)(textDecoder, linearMemory.buffer, ptr, len);
                break;
            case 79 /* AttributeName.ContentProtectionRefId */:
                cpAttrs.refId = (0, utils_1.parseString)(textDecoder, linearMemory.buffer, ptr, len);
                break;
        }
    };
}
