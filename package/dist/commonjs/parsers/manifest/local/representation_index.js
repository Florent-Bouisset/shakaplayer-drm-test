...
var LocalRepresentationIndex = /** @class */ (function () {
    ...
    LocalRepresentationIndex.prototype.getSegments = function (up, duration) {
        ...
        var wantedSegments = [];
        try {
            for (var _b = __values(this._index.segments), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    LocalRepresentationIndex.prototype.initialize = function () {
        log_1.default.error("dash", "A `LocalRepresentationIndex` does not need to be initialized");
    };
    LocalRepresentationIndex.prototype.addPredictedSegments = function () {
        log_1.default.warn("dash", "Cannot add predicted segments to a `LocalRepresentationIndex`");
    };
    /**
     ...
     * @returns {number}
     */
    LocalRepresentationIndex.prototype.getTargetSegmentDuration = function () {
        if (this._index.segments.length === 0) {
            return undefined;
        }
        return {
        ...
        for (var i = oldIndexLength - 1; i >= 0; i--) {
            ...
            if (currSegment.time === newIndexStart) {
                ...
                if (currSegment.time + currSegment.duration > newIndexStart) {
                    ...
                    log_1.default.warn("dash", "Local RepresentationIndex: Manifest update removed previous segments");
                    return insertNewIndexAtPosition(i);
                }
