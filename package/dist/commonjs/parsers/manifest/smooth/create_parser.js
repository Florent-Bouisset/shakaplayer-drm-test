...
function createSmoothStreamingParser(parserOptions) {
        ...
        switch (streamType) {
            case "audio": {
                ...
                if ((fourCC !== undefined && MIME_TYPES[fourCC] === undefined) ||
                    ...
                    log_1.default.warn("smooth", "Unsupported audio codec. Ignoring quality level.", {
                        fourCC: fourCC,
                    });
                    return null;
                }
            ...
            case "video": {
                ...
                if ((fourCC !== undefined && MIME_TYPES[fourCC] === undefined) ||
                    codecPrivateData === undefined) {
                    log_1.default.warn("smooth", "Unsupported video codec. Ignoring quality level.", {
                        fourCC: fourCC,
                    });
                    return null;
                }
            ...
            default:
                log_1.default.error("smooth", "Unrecognized StreamIndex type: " + streamType);
                return null;
        }
    }
    /**
    ...
    function parseAdaptation(args) {
        ...
        if (!(0, array_includes_1.default)(manifest_1.SUPPORTED_ADAPTATIONS_TYPE, typeAttribute)) {
            log_1.default.warn("smooth", "Unrecognized adaptation type:", typeAttribute);
        }
