...
var SharedSmoothSegmentTimeline = /** @class */ (function () {
    ...
    SharedSmoothSegmentTimeline.prototype.replace = function (newSmoothTimeline) {
        ...
        for (var i = 0; i < oldTimeline.length; i++) {
            ...
            if (oldEnd > newEnd) {
                ...
                if (rangeDuration === 0) {
                    log_1.default.warn("smooth", "a discontinuity detected in the previous manifest" + " has been resolved.");
    ...
    SharedSmoothSegmentTimeline.prototype.addPredictedSegments = function (nextSegments, currentSegment) {
        var e_1, _a;
        var _b;
        if (((_b = currentSegment.privateInfos) === null || _b === void 0 ? void 0 : _b.smoothMediaSegment) === undefined) {
            log_1.default.warn("smooth", "should only encounter SmoothRepresentationIndex");
            return;
        }
        this.refresh();
        try {
            for (var nextSegments_1 = __values(nextSegments), nextSegments_1_1 = nextSegments_1.next(); !nextSegments_1_1.done; nextSegments_1_1 = nextSegments_1.next()) {
                var nextSeg = nextSegments_1_1.value;
                (0, add_segment_infos_1.default)(this.timeline, this.timescale, nextSeg, currentSegment.privateInfos.smoothMediaSegment);
            }
        }
        catch (e_1_1) { e_1 = { error: e_1_1 }; }
        finally {
            try {
                if (nextSegments_1_1 && !nextSegments_1_1.done && (_a = nextSegments_1.return)) _a.call(nextSegments_1);
            }
