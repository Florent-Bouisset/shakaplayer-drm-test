 ...
 * @return {Array.<Object>}
 */
export default function parseWebVTTPlainText(text: string | BufferSource, _context: unknown, timeOffset: number): IVTTHTMLCue[];
//# sourceMappingURL=parse_webvtt_plain_text.d.ts.map