...
var PlaybackObserver = /** @class */ (function () {
    ...
    function PlaybackObserver(mediaElement, options) {
        ...
        var onLoadedMetadata = function () {
            if (_this._pendingSeek !== null && !_this._isSeekBlocked) {
     ...
     * point in time.
     */
    PlaybackObserver.prototype.blockSeeking = function () {
     ...
     */
    PlaybackObserver.prototype.isSeekingBlocked = function () {
     ...
     * `null` otherwise.
     */
    PlaybackObserver.prototype.getPendingSeekInformation = function () {
     ...
     */
    PlaybackObserver.prototype.listen = function (cb, params) {
    ...
    PlaybackObserver.prototype._getCurrentObservation = function (event) {
        ...
        if (tmpEvt === "seeking") {
            ...
            if (this._internalSeeksIncoming.length > 0) {
                ...
                this._expectedSeekingPosition = (0, is_seeking_approximate_1.default)()
            ...
            this._expectedSeekingPosition = Math.max(position, (_c = this._expectedSeekingPosition) !== null && _c !== void 0 ? _c : 0);
        }
        else if ((0, is_seeking_approximate_1.default)() &&
            this._expectedSeekingPosition !== null &&
        ...
        var basePosition = (_d = this._expectedSeekingPosition) !== null && _d !== void 0 ? _d : position;
        var currentRange;
        var bufferGap;
        ...
        var fullyLoaded = hasLoadedUntilTheEnd(basePosition, currentRange, mediaTimings.ended, mediaTimings.duration, this._lowLatencyMode);
        ...
        if (log_1.default.hasLevel("DEBUG")) {
            log_1.default.debug("media", "Current media element state tick.", {
                evt: timings.event,
    ...
    PlaybackObserver.prototype._generateObservationForEvent = function (event) {
        ...
        if (log_1.default.hasLevel("DEBUG")) {
            log_1.default.debug("media", "current playback timeline:\n" +
...
function getRebufferingStatus(_a) {
    var previousObservation = _a.previousObservation, currentObservation = _a.currentObservation, basePosition = _a.basePosition, observationEvent = _a.observationEvent, withMediaSource = _a.withMediaSource, lowLatencyMode = _a.lowLatencyMode, bufferGap = _a.bufferGap, fullyLoaded = _a.fullyLoaded;
    var REBUFFERING_GAP = config_1.default.getCurrent().REBUFFERING_GAP;
    var currentTime = currentObservation.position, paused = currentObservation.paused, readyState = currentObservation.readyState, ended = currentObservation.ended;
    ...
    var canSwitchToRebuffering = prevRebuffering === null && !(fullyLoaded || ended);
