...
exports.default = loadChunkedSegmentData;
 ...
 * @returns {Promise}
 */
function loadChunkedSegmentData(url, requestOptions, callbacks, cancelSignal) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var partialChunk, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    partialChunk = null;
                    return [4 /*yield*/, (0, fetch_1.default)({
                            url: url,
