...
function default_1(options) {
    var manifestLoader = (0, generate_manifest_loader_1.default)({ customManifestLoader: options.manifestLoader }, mightUseDashWasmFeature() ? "text" : "arraybuffer", options.checkManifestIntegrity === true ? integrity_checks_1.addManifestIntegrityChecks : null);
    ...
    return {
        ...
        thumbnails: {
            loadThumbnail: thumbnails_1.loadThumbnail,
            parseThumbnail: thumbnails_1.parseThumbnail,
        },
    };
}
/**
