...
function parseISOBMFFEmbeddedTextTrack(data, isChunked, context, initTimescale, __priv_patchLastSegmentInSidx) {
    ...
    if (isInit) {
        var segmentList = (0, isobmff_1.getSegmentsFromSidx)(chunkBytes, Array.isArray(indexRange) ? indexRange[0] : 0);
    ...
    var chunkData = (0, parse_text_track_1.getISOBMFFEmbeddedTextTrackData)(context, chunkBytes, initTimescale, chunkInfos, isChunked);
...
function parsePlainTextTrack(data, initTimescale, isChunked, context) {
    ...
    var chunkData = (0, parse_text_track_1.getPlainTextTrackData)(context, textTrackData, initTimescale, isChunked);
    return {
        segmentType: "media",
        chunkData: chunkData,
        chunkSize: chunkSize,
