...
function getLocalManifestPipelines(transportOptions) {
    ...
    var manifestPipeline = {
        ...
        parseManifest: function (manifestData) {
            ...
            var manifest = new classes_1.default(parsed, transportOptions);
    ...
    return {
        ...
        thumbnails: {
            loadThumbnail: function () {
                return Promise.reject(new Error("Thumbnail tracks aren't implemented with the local transport"));
            },
            parseThumbnail: function () {
