...
function fetchRequest(options) {
    ...
    log_1.default.debug("utils", "Fetch", { url: options.url });
    ...
    function abortFetch() {
        if ((0, is_null_or_undefined_1.default)(abortController)) {
            log_1.default.warn("utils", "Fetch: AbortController API not available.");
            return;
        }
    ...
    if (log_1.default.hasLevel("DEBUG")) {
        var logLine = "fetch GET " + options.url;
        if (options.timeout !== undefined) {
    ...
    return fetch(options.url, fetchOpts)
        ...
        if (response.status >= 300) {
            log_1.default.warn("utils", "Fetch: Request HTTP Error", {
        ...
        deregisterCancelLstnr();
        if (isTimedOut) {
            log_1.default.warn("utils", "Fetch: Request timed out.", {
                url: options.url,
            ...
            log_1.default.warn("utils", "Fetch: Request connection timed out.", {
                url: options.url,
        ...
        log_1.default.warn("utils", "Fetch: Request Error", {
