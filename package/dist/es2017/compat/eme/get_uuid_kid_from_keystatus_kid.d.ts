 ...
 * @returns {Uint8Array}
 */
export default function getUUIDKIDFromKeyStatusKID(keySystem: string, baseKeyId: Uint8Array<ArrayBuffer>): Uint8Array<ArrayBuffer>;
//# sourceMappingURL=get_uuid_kid_from_keystatus_kid.d.ts.map