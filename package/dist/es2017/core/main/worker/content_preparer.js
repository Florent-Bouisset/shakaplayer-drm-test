...
export default class ContentPreparer {
    ...
    initializeNewContent(context) {
        return new Promise((res, rej) => {
            ...
            const { contentId, url, hasText, transportOptions, useMseInWorker, enableRepresentationAvoidance, } = context;
            let manifest = null;
            // TODO better way
            ...
            const manifestFetcher = new ManifestFetcher(url === undefined ? undefined : [url], dashPipelines, Object.assign({ cmcdDataBuilder }, context.manifestRetryOptions));
            ...
            const segmentQueueCreator = new SegmentQueueCreator(dashPipelines, cdnPrioritizer, cmcdDataBuilder, context.segmentRetryOptions);
            const fetchThumbnailData = createThumbnailFetcher(dashPipelines.thumbnails, cdnPrioritizer);
            const trackChoiceSetter = new TrackChoiceSetter();
            const [mediaSource, segmentSinksStore, workerTextSender] = createMediaSourceInterfaceAndSegmentSinksStore(contentId, {
                useMseInWorker,
    ...
    reloadMediaSource() {
        ...
        this._currentMediaSourceCanceller = new TaskCanceller();
        const [mediaSourceInterface, segmentSinksStore, workerTextSender] = createMediaSourceInterfaceAndSegmentSinksStore(this._currentContent.contentId, {
