...
import log from "../../../log";
import { resetMediaElement, disableRemotePlaybackOnManagedMediaSource, } from "../../../main_thread/init/utils/create_media_source";
...
export default function prepareSourceBuffer(videoElement, codec, cleanUpSignal) {
    return createCancellablePromise(cleanUpSignal, (resolve, reject) => {
        ...
        if (mediaSource.handle.type === "handle") {
            ...
            log.info("VideoThumbnailLoader", "Attaching MediaSource URL to the media element", objectURL);
