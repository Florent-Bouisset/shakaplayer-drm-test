 ...
 */
export declare function emitSeekEvents(playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, onSeeking: () => void, onSeeked: () => void, cancelSignal: CancellationSignal): void;
/**
 ...
 * remove all listeners this function has registered.
 */
export declare function emitPlayPauseEvents(mediaElement: IMediaElement | null, onPlay: () => void, onPause: () => void, cancelSignal: CancellationSignal): void;
...
export declare function constructPlayerStateReference(initializer: ContentInitializer, mediaElement: IMediaElement, playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, isDirectFile: boolean, cancelSignal: CancellationSignal): IReadOnlySharedReference<IPlayerState>;
/**
 ...
 * @returns {string}
 */
export declare function getLoadedContentState(mediaElement: IMediaElement, stalledStatus: IStallingSituation | null, isDirectFile: boolean, previousState: IPlayerState): IPlayerState;
