 ...
 */
export default async function initMediaKeys(eme, mediaElement, keySystemsConfigs, cancelSignal) {
    const mediaKeysInfo = await getMediaKeysInfos(eme, mediaElement, keySystemsConfigs, cancelSignal);
