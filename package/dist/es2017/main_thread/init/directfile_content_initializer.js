...
function getDirectFileInitialTime(mediaElement, startAt) {
    ...
    if (typeof startAt.fromLastPosition === "number") {
        ...
        log.warn("Init", "startAt.fromLastPosition set but duration is not known, " +
        ...
        if (isNullOrUndefined(livePosition)) {
            log.warn("Init", "startAt.fromLivePosition set but live position is not known, " +
                "beginning at 0.");
            return 0;
        }
        ...
        if (isNullOrUndefined(duration) || !isFinite(duration)) {
            log.warn("Init", "startAt.percentage set but duration is not known, " + "beginning at 0.");
            return 0;
        }
