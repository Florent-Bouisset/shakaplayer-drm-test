...
export function resetMediaElement(mediaElement, mediaSourceURL) {
    ...
    if (mediaSourceURL !== null) {
        try {
            ...
            log.warn("media", "Error while revoking the media source URL", e instanceof Error ? e : "");
        }
    }
}
/**
...
function createMediaSource(mediaElement, unlinkSignal) {
    ...
    const mediaSource = new MainMediaSourceInterface(generateMediaSourceId(), "FORCED_MEDIA_SOURCE" in mediaElement ? mediaElement.FORCED_MEDIA_SOURCE : undefined);
