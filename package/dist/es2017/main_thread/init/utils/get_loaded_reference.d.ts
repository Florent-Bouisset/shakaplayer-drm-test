 ...
 * @returns {Object}
 */
export default function getLoadedReference(playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, isDirectfile: boolean, cancelSignal: CancellationSignal): IReadOnlySharedReference<boolean>;
//# sourceMappingURL=get_loaded_reference.d.ts.map