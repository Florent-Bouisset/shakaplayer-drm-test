...
export default class HTMLTextDisplayer {
    ...
    pushTextData(infos) {
        ...
        const { start: startTime, end: endTime, data: dataRaw, type, language, initTimescale, } = chunk;
        ...
        const cues = parseTextTrackToElements(type, dataRaw, { initTimescale, language }, timestampOffset);
