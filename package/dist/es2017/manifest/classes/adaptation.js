    ...
    constructor(parsedAdaptation, cachedCodecSupport, options = {}) {
        ...
        for (let i = 0; i < argsRepresentations.length; i++) {
            ...
            if (shouldAdd) {
                ...
                log.debug("manifest", "Filtering Representation due to representationFilter", this.type, `Adaptation: ${this.id}`, `Representation: ${representation.id}`, `(${representation.bitrate})`);
            }
        }
