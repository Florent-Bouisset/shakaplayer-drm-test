...
export default class Manifest extends EventEmitter<IManifestEvents> implements IManifestMetadata {
     ...
     */
    updateCodecSupport(updatedCodecSupportInfo?: ICodecSupportInfo[]): MediaError | null;
    /**
    ...
    updateCodecSupportList(cachedCodecSupport: CodecSupportCache): void;
    /**
     ...
     */
    addRepresentationsToAvoid(items: Array<{
        period: Period;
        adaptation: Adaptation;
        representation: Representation;
    }>): void;
     ...
     */
    getCodecsWithUnknownSupport(): Array<{
        mimeType: string;
        codec: string;
    }>;
    /**
