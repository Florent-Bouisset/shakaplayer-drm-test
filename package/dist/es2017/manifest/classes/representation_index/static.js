...
export default class StaticRepresentationIndex {
    ...
    initialize() {
        log.error("manifest", "A `StaticRepresentationIndex` does not need to be initialized");
    }
    /**
    ...
    addPredictedSegments() {
        log.warn("manifest", "Cannot add predicted segments to a `StaticRepresentationIndex`");
    }
    _replace() {
