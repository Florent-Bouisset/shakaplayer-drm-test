 ...
 */
declare function getChildBox<T extends ArrayBufferLike>(buf: Uint8Array<T>, childNames: number[]): Uint8Array<T> | null;
/**
 ...
 * @returns {UInt8Array|null}
 */
declare function getBoxContent<T extends ArrayBufferLike>(buf: Uint8Array<T>, boxName: number): Uint8Array<T> | null;
/**
 ...
 */
declare function getBoxesContent<T extends ArrayBufferLike>(buf: Uint8Array<T>, boxName: number): Array<Uint8Array<T>>;
/**
 ...
 * @returns {UInt8Array|null}
 */
declare function getBox<T extends ArrayBufferLike>(buf: Uint8Array<T>, boxName: number): Uint8Array<T> | null;
/**
 ...
 */
declare function getUuidContent<T extends ArrayBufferLike>(buf: Uint8Array<T>, id1: number, id2: number, id3: number, id4: number): Uint8Array<T> | undefined;
/**
...
//# sourceMappingURL=get_box.d.ts.map