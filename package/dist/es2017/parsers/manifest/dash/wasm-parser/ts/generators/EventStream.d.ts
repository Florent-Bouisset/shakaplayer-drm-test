 ...
 * @returns {Function}
 */
export declare function generateEventStreamChildrenParser(childrenObj: IEventStreamChildren, linearMemory: WebAssembly.Memory, parsersStack: ParsersStack, fullMpd: ArrayBufferLike): IChildrenParser;
/**
