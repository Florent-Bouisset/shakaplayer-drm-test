 ...
 */
import type { IPeriodAttributes, IPeriodChildren } from "../../../node_parser_types";
 ...
 * @returns {Function}
 */
export declare function generatePeriodChildrenParser(periodChildren: IPeriodChildren, linearMemory: WebAssembly.Memory, parsersStack: ParsersStack, fullMpd: ArrayBufferLike): IChildrenParser;
/**
