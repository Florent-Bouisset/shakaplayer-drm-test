 ...
 * @return {Array.<Object>}
 */
export default function parseMp4EmbeddedWebVttToVTTCues(input, { initTimescale }, timeOffset) {
    if (typeof input === "string") {
        return parseMp4EmbeddedWebVtt(strToUtf8(input), initTimescale !== null && initTimescale !== void 0 ? initTimescale : 1, timeOffset, toNativeCue);
    }
    else {
        return parseMp4EmbeddedWebVtt(bufferSourceToUint8(input), initTimescale !== null && initTimescale !== void 0 ? initTimescale : 1, timeOffset, toNativeCue);
    }
}
