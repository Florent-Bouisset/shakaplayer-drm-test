...
import type { ISegmentLoaderCallbacks, ISegmentLoaderResultChunkedComplete } from "../types";
/**
 ...
 * @returns {Promise}
 */
export default function loadChunkedSegmentData(url: string, requestOptions: {
    headers: Record<string, string> | undefined;
    timeout: number | undefined;
    connectionTimeout: number | undefined;
}, callbacks: ISegmentLoaderCallbacks<Uint8Array<ArrayBuffer>>, cancelSignal: CancellationSignal): Promise<ISegmentLoaderResultChunkedComplete>;
//# sourceMappingURL=load_chunked_segment_data.d.ts.map