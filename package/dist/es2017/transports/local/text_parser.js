...
function parseISOBMFFEmbeddedTextTrack(data, isChunked, context, initTimescale) {
    ...
    const chunkData = getISOBMFFEmbeddedTextTrackData(context, chunkBytes, initTimescale, chunkInfos, isChunked);
...
function parsePlainTextTrack(data, initTimescale, isChunked, context) {
    ...
    const chunkData = getPlainTextTrackData(context, textTrackData, initTimescale, isChunked);
    const chunkOffset = (_a = segment.timestampOffset) !== null && _a !== void 0 ? _a : 0;
    return {
        segmentType: "media",
        chunkData,
