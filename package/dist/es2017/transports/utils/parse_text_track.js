 ...
 * @returns {Object|null}
 */
export function getISOBMFFEmbeddedTextTrackData({ segment, language, codecs, }, chunkBytes, initTimescale, chunkInfos, isChunked) {
    if (segment.isInit) {
        return null;
    }
    let startTime;
 ...
 * @returns {Object|null}
 */
export function getPlainTextTrackData(context, textTrackData, initTimescale, isChunked) {
